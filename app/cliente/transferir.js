...
export default function TransferenciaPremium() {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceHint}>Escolha o cartão e faça a transferência</Text>
        </View>
        ...
        {/* Inputs da transferência */}
        <View
          style={[
            styles.inputContainer,
            focusedInput === "destinatario" && { borderColor: "#4C44C1" }
          ]}
        >
          <Ionicons name="person-outline" size={20} color="#4C44C1" />
          <TextInput
            placeholder="Destinatário/NBT"
            placeholderTextColor="#9B9B9B"
            style={styles.input}
            value={destinatario}
            onChangeText={setDestinatario}
            onFocus={() => setFocusedInput("destinatario")}
      ...
      <Modal visible={successModalVisible} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>Transferência realizada com sucesso</Text>
            <TouchableOpacity
