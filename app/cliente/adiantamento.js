    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.fixedHeader}>
          ...
          <Text style={styles.headerTitle}>Adiantamento</Text>
          <View style={{ width: 26 }} />
        </View>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.button} onPress={handleLevantamento}>
            <LinearGradient colors={["#8F80FF", "#4C44C1"]} style={styles.buttonGradient}>
              ...
              <Text style={styles.buttonText}>Confirmar adiantamento</Text>
            </LinearGradient>
          </TouchableOpacity>

          {/* Histórico */}
          <View style={{ marginTop: 30 }}>
            <Text style={styles.historyTitle}>Histórico de adiantamento</Text>

            {history.length === 0 && (
              <Text style={styles.emptyText}>Nenhum adiantamento ainda.</Text>
            )}
...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingTop: 120, paddingHorzontal: 18, paddingBottom: 40 },
